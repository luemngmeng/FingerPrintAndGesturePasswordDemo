 ...
 *  解锁背景色
 */
#define CircleViewBackgroundColor rgba(248,248,248,1)

/**
 *  普通状态下外空心圆颜色
 */
#define CircleStateNormalOutsideColor rgba(199,199,199,1)
 ...
 *  普通状态下文字提示的颜色
 */
#define textColorNormalState rgba(128,128,128,1)
